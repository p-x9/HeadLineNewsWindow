...
class RootListController: PSListController {
    ...
    static let PREF_PATH  = "/var/mobile/Library/Preferences/com.p-x9.headlinenewswindow.pref.plist"
    static let NOTIFY = "com.p-x9.headlinenewswindow.prefschanged"
